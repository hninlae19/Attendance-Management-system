<div class="mb-6 flex justify-between items-center" data-aos="fade-down">
    <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">
            Salary History: <?= htmlspecialchars($data['employee']['FirstName'] . ' ' . $data['employee']['LastName']) ?>
        </h1>
        <p class="text-gray-500 text-sm mt-1">View monthly salary records, bonuses, deductions, and net pay for this employee.</p>
    </div>
    <a href="/payrollsystem/admin/employees" class="bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 font-bold py-2.5 px-5 rounded-lg flex items-center transition-all duration-300">
                ...
                <?php else: ?>
                    ...
                    <tr class="bg-white/50 border-b dark:bg-gray-800/50 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right">
                            <a href="/payrollsystem/admin/payroll_slip/<?= $pr['PayrollID'] ?>" class="font-medium text-primary hover:text-indigo-700 hover:underline inline-flex items-center gap-1 transition-colors">
