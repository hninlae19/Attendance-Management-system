...
<div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-violet-500 to-cyan-500 border border-violet-500/25 p-6 lg:p-7 mb-8 shadow-2xl" data-aos="fade-down">
    <div class="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-gray-700 dark:text-gray-300 text-xs sm:text-sm mt-1">Structure and maintain business divisions, operational teams, and functional departments.</p>
        </div>
            ...
            <tbody class="divide-y divide-violet-900/30">
                ...
                <?php else: ?>
                    ...
                    <tr class="hover:bg-violet-950/20 transition-colors group">
                        ...
                        <td class="px-6 py-4 font-bold text-gray-900 dark:text-gray-900 dark:text-white group-hover:text-violet-600 dark:group-hover:text-violet-300 transition-colors flex items-center gap-2.5">
    ...
    <div class="card-glass rounded-3xl max-w-md w-full shadow-2xl border border-violet-500/30 overflow-hidden">
        ...
        <form action="/payrollsystem/admin/departments" method="POST" class="p-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" id="name" required class="w-full px-3.5 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-violet-700/30 text-gray-900 dark:text-white rounded-xl focus:ring-2 focus:ring-violet-500 text-xs shadow-inner" placeholder="e.g. Information Technology">
            </div>
            <div class="flex justify-end gap-3 mt-6">
                ...
                <button type="submit" class="px-5 py-2 text-xs font-extrabold text-gray-900 dark:text-white bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 rounded-xl shadow-lg shadow-violet-600/30 transition-all">Save Department</button>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="card-glass rounded-3xl max-w-md w-full shadow-2xl border border-violet-500/30 overflow-hidden">
        ...
        <form action="/payrollsystem/admin/departments" method="POST" class="p-6">
            ...
            <div class="flex justify-end gap-3 mt-6">
                ...
                <button type="submit" class="px-5 py-2 text-xs font-extrabold text-gray-900 dark:text-white bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 rounded-xl shadow-lg shadow-violet-600/30 transition-all">Update Department</button>
            </div>
        </form>
    </div>
</div>
