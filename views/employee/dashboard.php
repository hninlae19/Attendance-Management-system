...
<div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 via-violet-500 to-cyan-500 border border-violet-500/25 p-6 lg:p-8 mb-8 shadow-2xl" data-aos="fade-down">
    ...
    <div class="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6">
        ...
        <div class="max-w-2xl text-center lg:text-left space-y-3">
            ...
            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight font-outfit">
            ...
            <div class="flex flex-wrap items-center justify-center lg:justify-start gap-2 pt-1 text-xs">
                <span class="px-3 py-1.5 rounded-xl bg-surface/90 border border-gray-300 dark:border-violet-700/30 text-gray-700 dark:text-gray-300 flex items-center gap-2">
                    <i class="fa-solid fa-building-user text-primary-light"></i>
                    <span>Dept: <strong class="text-gray-900 dark:text-white"><?= htmlspecialchars($data['employee']['DeptName'] ?? 'General') ?></strong></span>
                </span>
                <span class="px-3 py-1.5 rounded-xl bg-surface/90 border border-gray-300 dark:border-violet-700/30 text-gray-700 dark:text-gray-300 flex items-center gap-2">
                    <i class="fa-solid fa-id-badge text-secondary"></i>
                    <span>Role: <strong class="text-gray-900 dark:text-white"><?= htmlspecialchars($data['employee']['PositionName'] ?? 'Staff') ?></strong></span>
                </span>
            </div>
        </div>
        ...
        <div class="flex flex-col sm:flex-row lg:flex-col items-center gap-4 flex-shrink-0">
            <div class="relative group">
                ...
                <div class="relative w-40 h-40 sm:w-44 sm:h-44 rounded-3xl overflow-hidden border-2 border-violet-400/40 shadow-2xl bg-gray-50 dark:bg-gray-800/80">
    ...
    <div class="lg:col-span-1" data-aos="fade-up" data-aos-delay="100">
        <div class="card-glass rounded-3xl p-6 lg:p-7 relative overflow-hidden text-center flex flex-col justify-between h-full">
            ...
            <div>
                ...
                <div class="p-5 rounded-2xl bg-surface/90 border border-gray-300 dark:border-violet-700/30 mb-6 shadow-inner relative group">
                    <div class="text-xs uppercase font-bold tracking-wider text-gray-600 dark:text-gray-400 mb-1">Current Server Time</div>
                ...
                <?php if (!$data['is_working_day']): ?>
                    ...
                    <div class="p-6 bg-surface/90 border border-violet-800/40 rounded-2xl text-center">
                        <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-violet-900/30 text-gray-600 dark:text-gray-400 mb-3 border border-gray-300 dark:border-violet-700/30">
                            <i class="fa-solid fa-calendar-xmark text-2xl"></i>
                        </div>
                        <p class="font-bold text-gray-900 dark:text-white text-base mb-1">Non-Working Day</p>
                        <p class="text-xs text-gray-600 dark:text-gray-400">Attendance recording is currently disabled for weekends / official holidays.</p>
                    </div>
                ...
                <?php elseif($data['todayRecord'] && !$data['todayRecord']['CheckOutTime']): ?>
                    ...
                    <form action="/payrollsystem/employee/attendance" method="POST" class="relative z-10">
                        ...
                        <button type="submit" class="w-full bg-gradient-to-r from-rose-500 via-red-600 to-rose-600 hover:from-rose-400 hover:to-red-500 text-gray-900 dark:text-white font-extrabold text-base py-4 px-6 rounded-2xl shadow-xl shadow-rose-600/30 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3">
                ...
                <?php else: ?>
                    ...
                    <div class="p-6 bg-surface/90 border border-emerald-500/30 rounded-2xl relative z-10 text-center">
                        ...
                        <p class="font-extrabold text-gray-900 dark:text-white text-base mb-1 font-outfit">Shift Completed Today</p>
                        <p class="text-xs text-gray-600 dark:text-gray-400 mb-4">Your working hours have been logged successfully.</p>
                        
                        <div class="flex justify-between items-center text-xs px-4 py-2.5 bg-darker/60 rounded-xl border border-violet-900/30">
                            <span class="text-gray-600 dark:text-gray-400">IN: <strong class="text-emerald-300"><?= !empty($data['todayRecord']['CheckInTime']) ? date('h:i A', strtotime($data['todayRecord']['CheckInTime'])) : '--:--' ?></strong></span>
                            <span class="text-gray-600">|</span>
                            <span class="text-gray-600 dark:text-gray-400">OUT: <strong class="text-cyan-300"><?= !empty($data['todayRecord']['CheckOutTime']) ? date('h:i A', strtotime($data['todayRecord']['CheckOutTime'])) : '--:--' ?></strong>
            ...
            <!-- Footer Badge -->
            <div class="mt-6 pt-4 border-t border-violet-900/40 flex items-center justify-center gap-2 text-gray-600 dark:text-gray-400 text-xs">
    ...
    <div class="lg:col-span-2 space-y-6" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="card-glass rounded-2xl p-5 flex items-center group hover:-translate-y-1 transition-all">
                ...
                <div>
                    ...
                    <p class="text-lg font-extrabold text-gray-900 dark:text-white font-mono">EMP-<?= str_pad($data['employee']['EmpID'], 4, '0', STR_PAD_LEFT) ?></p>
                </div>
            </div>
            ...
            <div class="card-glass rounded-2xl p-5 flex items-center group hover:-translate-y-1 transition-all">
                ...
                <div>
                    ...
                    <p class="text-base font-bold text-gray-900 dark:text-white truncate max-w-[140px]"><?= htmlspecialchars($data['employee']['DeptName'] ?? 'General') ?></p>
                </div>
            </div>
            ...
            <div class="card-glass rounded-2xl p-5 flex items-center group hover:-translate-y-1 transition-all">
                ...
                <div>
                    ...
                    <p class="text-base font-bold text-gray-900 dark:text-white truncate max-w-[140px]"><?= htmlspecialchars($data['employee']['PositionName'] ?? 'Staff') ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="card-glass rounded-2xl overflow-hidden">
            <div class="p-4 px-6 border-b border-violet-900/40 flex justify-between items-center bg-gray-50 dark:bg-gray-800/60">
                ...
                <a href="/payrollsystem/employee/overtime" class="text-xs font-bold text-violet-300 hover:text-gray-900 dark:text-white transition-colors">View All</a>
            </div>
                    ...
                    <tbody class="divide-y divide-violet-900/30">
                        <?php if (empty($data['upcomingOvertime'])): ?>
                            <tr>
                                <td colspan="5" class="px-6 py-10 text-center text-gray-500">
                                    <div class="w-12 h-12 mx-auto bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-violet-900/40 flex items-center justify-center mb-2 text-violet-400">
                                        <i class="fa-solid fa-mug-hot text-xl"></i>
                                    </div>
                                    <p class="font-semibold text-gray-700 dark:text-gray-300">No overtime scheduled</p>
                        ...
                        <?php else: ?>
                            ...
                            <tr class="hover:bg-violet-950/20 transition-colors">
                                <td class="px-5 py-3.5 font-bold text-gray-900 dark:text-white"><?= date('D, M j, Y', strtotime($ot['OvertimeDate'])) ?></td>
                                <td class="px-4 py-3.5 text-xs text-gray-700 dark:text-gray-300 font-medium">
                                ...
                                <td class="px-4 py-3.5">
                                    <?php 
                                        $statusColors = [
                                            ...
                                            'No Show' => 'bg-gray-500/15 text-gray-700 dark:text-gray-300 border border-gray-500/30',
        ...
        <div class="card-glass rounded-2xl overflow-hidden">
            <div class="p-4 px-6 border-b border-violet-900/40 flex justify-between items-center bg-gray-50 dark:bg-gray-800/60">
                ...
                <a href="/payrollsystem/employee/salary_history" class="text-xs font-bold text-violet-300 hover:text-gray-900 dark:text-white transition-colors">Salary History</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-600 dark:text-gray-400">
                    <thead class="text-xs uppercase bg-gray-50 dark:bg-gray-900/80 text-violet-700 dark:text-violet-300/80 border-b border-gray-200 dark:border-violet-900/40">
                    ...
                    <tbody class="divide-y divide-violet-900/30">
                        <?php if (empty($data['recentPayrolls'])): ?>
                            <tr>
                                <td colspan="4" class="px-6 py-10 text-center text-gray-500">
                                    ...
                                    <p class="font-semibold text-gray-700 dark:text-gray-300">No payroll records yet</p>
                        ...
                        <?php else: ?>
                            ...
                            <tr class="hover:bg-violet-950/20 transition-colors">
                                <td class="px-5 py-3.5 font-bold text-gray-900 dark:text-white"><?= htmlspecialchars($pr['PayrollMonth']) ?></td>
                                <td class="px-4 py-3.5">
                                ...
                                <td class="px-4 py-3.5 text-right font-extrabold text-emerald-400">
                                    <?= number_format($pr['NetSalary']) ?> <span class="text-xs font-normal text-gray-600 dark:text-gray-400">MMK</span>
                                </td>
